...
public class Proveedor {
    ...
    public static void venderProducto(Inventario inventario, String nombreProducto, int cantidadVenta) {
        Producto producto = inventario.buscarProductoPorNombre(nombreProducto); //instanciamos de la clase inventario

        if (producto == null) {   // si no se encuntra el producoto en la lista
        ...
        if (cantidadVenta <= cantidadDisponible) {
            ...
            System.out.println("Se vendieron " + cantidadVenta + " unidades de " + nombreProducto + ".");
                                    ...
                                    // Verificar si la cantidad es menor a 5 para llamar o proveedor
